    ...
    return (
      <div>
        <Router>
          ...
          <Routes>
            {/* <Route exact path='/about'> This is About Page </Route> */}
            ...
            <Route exact path='/sports' element={<News key="soprts" pageSize={this.pageSize} country="in" category='sports' />}> </Route>
